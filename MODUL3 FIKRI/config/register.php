...
function registrasi ($data){
    ...
    $password = mysqli_real_escape_string($connect_user,$data["Password"]); //=> memungkina user memasukkan password ada kutipnya, 
    $confirmPassword = mysqli_real_escape_string($connect_user,$data["confirmPassword"]); //=> memungkina user memasukkan password ada kutipnya,
