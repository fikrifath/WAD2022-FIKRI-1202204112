...
$sql = "SELECT * FROM showroom_fikri_table WHERE id_mobil = $id";
...
<head>
  ...
  <title>DETAIL-FIKRI FATHONI-1202204112</title>
        ...
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Edit-fath.php?id=" . $getDetail["id_mobil"] . "' class='btn btn-primary' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
